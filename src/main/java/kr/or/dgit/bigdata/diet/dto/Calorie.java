...
public class Calorie {
	...
	public int getCal_woman() {
		return cal_woman;
	}
	public int getH_woman() {
		return h_woman;
	}
	public int getW_woman() {
		return w_woman;
	}
	...
	public void setCal_man(int cal_man) {
		this.cal_man = cal_man;
	}
	public void setH_man(int h_man) {
		this.h_man = h_man;
	}
	public void setW_man(int w_man) {
		this.w_man = w_man;
	}
	public void setCal_woman(int cal_woman) {
		this.cal_woman = cal_woman;
	}
	public void setH_woman(int h_woman) {
		this.h_woman = h_woman;
	}
	public void setW_woman(int w_woman) {
